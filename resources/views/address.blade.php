<form action="/shop/address" method="post">
    @csrf
    <div class="card" style="min-height:910px;padding-right: 10px; padding-left: 10px;margin-top: 80px; direction: rtl;text-align: right">


        <div class="col-lg-5" style="right: 30%;top: 48px;">

        <span style="width: 100%;
background: #eee;padding: 8px;position: absolute;">مشخصات شما</span>


            <div class="form-group" style="margin-top: 45px;">
                <label>نام</label>

                <input type="text" name="name" class="form-control col-lg-6" placeholder="نام خود را وارد کنید ">
            ...
            <div class="form-group col-lg-6" style="margin-top: 45px;position: absolute;left: 0;top: 0;">

                <label>نام خانوادگی</label>
                <input type="text" name="lname" class="form-control " placeholder="نام خانوادگی خود را وارد کنید ">
            ...
            <div class="form-group" style="margin-top: 45px;">
                ...
                <input type="text" name="codemeli" class="form-control col-lg-12" placeholder="کد ملی خود را وارد کنید">


            </div>

            <div class="form-group" style="margin-top: 45px;">
                <span style="position: absolute;right: 6%;"> تبعه خارجی فاقد کد ملی هستم</span>

                <input type="checkbox"  name="nocode" value="1">
...
background: #eee;padding: 8px;position: absolute;">مشخصات شما</span>
            ...
            <div class="form-group" style="margin-top: 45px;">
                ...
                <input type="text"  name="fullname" class="form-control col-lg-6" placeholder="نام خود را وارد کنید ">
            ...
            <div class="form-group col-lg-6" style="margin-top: 45px;position: absolute;left: 0;top: 0;">
                ...
                <input type="text" name="mobile" class="form-control " placeholder="نام خانوادگی خود را وارد کنید ">
            ...
            <div class="form-group" style="margin-top: 45px;">
                ...
                <select id="state" name="province" onchange="Func()" class="form-control col-lg-6">
            ...
            <div class="form-group col-lg-6" style="margin-top: 45px;position: absolute;left: 0;top: 110px;">
            ...
            <div class="form-group col-lg-12" style="margin-top: 45px;position: absolute;left: 0;top: 205px;">

                <label>آدرس پستی</label>
                <textarea class="form-control" name="address"></textarea>
            </div>
            <div class="form-group col-lg-12" style="margin-top: 45px;position: absolute;left: 0;top: 340px;">

                <label>کد پستی</label>
                <input type="text" name="zipcode" placeholder="کد پستی خود را بدون خط تیره بنویسید" class="form-control">
            </div>
